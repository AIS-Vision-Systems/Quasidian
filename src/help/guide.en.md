...
`Ctrl+E` toggles between **editing** (Live Preview: syntax hides away from the active line) and **reading** (rendered HTML, only task checkboxes stay interactive). The book button in the file bar does the same.
